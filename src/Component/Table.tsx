...
export default function TemplateDemo({ productss, fresh,api }: any) {
    ...
    <>
      ...
      <div className="card">
        ...
        >
          <Column
            header="S.No"
            body={(_rowData: Product, options: { rowIndex: number }) =>
              options.rowIndex + 1
            }
          />
          ...
          <Column
            ...
            body={(rowData) => (
              <button
                ...
                onClick={() => {
                  edit(rowData.id.toString(), rowData);
                }}
              >
                Edit
              </button>
